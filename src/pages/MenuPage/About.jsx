          ...
          <div className="flex flex-wrap justify-center gap-[30px] md:gap-[50px] items-center mx-[20px] md:mx-[100px]">
            ...
            >
              <div className="relative w-[300px] md:w-[499px] h-[300px] md:h-[499px]">
                ...
                />
                <div className="absolute left-[50%] transform -translate-x-1/2 text-primary font-bold font-kh text-[35px] md:text-[50px]">
                  NHAM <span className="text-[#FBBF24]">EY</span>
                </div>
                <div className="absolute bottom-[100px] md:bottom-[200px] right-[10%] md:right-[480px] text-primary font-kh font-bold text-[24px] md:text-[32px]">
                  TEAM
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-6 max-w-5xl w-full">
              <img
                ...
                alt="About Us"
                className="w-[414px] h-auto md:h-[331px] object-contain rounded-lg"
              />
          ...
          >
            <div className="flex flex-col md:flex-row-reverse items-center gap-6 max-w-5xl w-full">
              <img
                ...
                alt="About Us"
                className="w-[414px] h-auto md:h-[331px] object-contain rounded-lg my-10"
              />
