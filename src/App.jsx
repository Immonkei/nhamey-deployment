        ...
        <div className="text-center my-12">
          ...
          <div className="flex justify-center my-10">
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              <NavLink to="/food?category=breakfast" data-aos="zoom-in">
                <FoodCategory image="/images/food/breakfast.png" title="Breakfast" />
              </NavLink>
              <NavLink to="/food?category=lunch" data-aos="zoom-in">
                <FoodCategory image="/images/food/lunch.png" title="Lunch" />
              </NavLink>
              <NavLink to="/food?category=dessert" data-aos="zoom-in">
                <FoodCategory image="/images/food/dessert.png" title="Dessert" />
              </NavLink>
              <NavLink to="/food?category=snack" data-aos="zoom-in">
          ...
          <div className="flex justify-center">
            <div className="grid max-w-500 sm:grid-cols-1 md:grid-cols-2 gap-6 px-4 mt-10">
              {trendingRestaurant.map((res) => (
                <div data-aos="fade-up" key={`trending-${res.id}`}>
                  <ResturantCard
                    id={res.id}
                    name={res.name}
          ...
          <div className="flex justify-center mt-10">
            <div className="grid sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-4">
              {trendingFood.map((food) => (
                <div data-aos="fade-up" key={`trending-${food.id}`}>
                  <FoodCard
                    id={food.id}
                    name={food.name}
                    price={food.price}
